...
def setupCustomizedAK8(process, runOnMC=False, path=None, Settype=''):
    ...
    process.imageJetsAK8Puppi = cms.EDProducer('ImageProducer',
        ...
        pb_path=cms.untracked.FileInPath('PhysicsTools/NanoHRT/data/Image/Iv9test.pb'),
        pb_pathMD=cms.untracked.FileInPath('PhysicsTools/NanoHRT/data/Image/Iv9test.pb'),
