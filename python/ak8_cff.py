...
def setupCustomizedAK8(process, runOnMC=False, path=None):
    ...
    process.customAK8Table = cms.EDProducer("SimpleCandidateFlatTableProducer",
        ...
        variables=cms.PSet(P4Vars,
            ...
            iMDtopfless=Var("userFloat('ImageMD:topfless')", float, doc="Image MD top tagger score (without b tagging)", precision=-1),
            ...
            iMDWWfless=Var("userFloat('ImageMD:wwfless')", float, doc="Image MD ww->qqqq tagger score (without b tagging)", precision=-1),
...
def setupCustomizedWWAK8(process, runOnMC=False, path=None):
    ...
    jetToolbox(process, 'ak8', 'dummySeq', 'out', associateTask=False,
		       PUMethod='Puppi', JETCorrPayload='AK8PFPuppi', JETCorrLevels=JETCorrLevels,
		       Cut='pt > 170.0 && abs(rapidity()) < 2.4',
		       postFix=pfix,miniAOD=True, runOnMC=runOnMC,svLabel=cms.InputTag("WWProducerpuppi1","linkedsvs"),elLabel=cms.InputTag("WWProducerpuppi","newels"), muLabel=cms.InputTag("WWProducerpuppi","newmus"),  
		       addNsub=True, maxTau=4, addEnergyCorrFunc=True,
		       GetSubjetMCFlavour=False,GetJetMCFlavour=False,
		       addSoftDrop=True, addSoftDropSubjets=True, subJETCorrPayload='AK4PFPuppi', subJETCorrLevels=JETCorrLevels,
		       bTagDiscriminators=bTagDiscriminators, subjetBTagDiscriminators=subjetBTagDiscriminators,
    ...
    jetToolbox( process, 'ak8', 'ak8JetSubs', 'out', associateTask=False, 
		updateCollection='packedPatJetsAK8PFPuppi'+pfix+'SoftDrop', JETCorrPayload='AK8PFPuppi', JETCorrLevels=JETCorrLevels,
                Cut='pt > 170.0 && abs(rapidity()) < 2.4',svLabel=cms.InputTag("WWProducerpuppi1","linkedsvs"), elLabel=cms.InputTag("WWProducerpuppi","newels"), muLabel=cms.InputTag("WWProducerpuppi","newmus"), 
                miniAOD=True, runOnMC=runOnMC,bTagDiscriminators=bTagDiscriminators + _pfDeepBoostedJetTagsProbs + _pfMassDecorrelatedDeepBoostedJetTagsProbs,
    ...
    process.customWWAK8Table = cms.EDProducer("SimpleCandidateFlatTableProducer",
        ...
        variables=cms.PSet(P4Vars,
            ...
            iMDtopfless=Var("userFloat('ImageMDWW:topfless')", float, doc="Image MD top tagger score", precision=-1),
            ...
            iMDWWfless=Var("userFloat('ImageMDWW:wwfless')", float, doc="Image MD ww->qqqq tagger score", precision=-1),
    ...
    jetToolbox(process, 'ak8', 'dummySeq', 'out', associateTask=False,
		       ...
		       GetSubjetMCFlavour=False,GetJetMCFlavour=False,svLabel=cms.InputTag("WBProducerpuppi1","linkedsvs"), 
		       addSoftDrop=True, addSoftDropSubjets=True, subJETCorrPayload='AK4PFPuppi', subJETCorrLevels=JETCorrLevels,
		       bTagDiscriminators=bTagDiscriminators, subjetBTagDiscriminators=subjetBTagDiscriminators,
    ...
    jetToolbox( process, 'ak8', 'ak8JetSubs', 'out', associateTask=False, 
		updateCollection='packedPatJetsAK8PFPuppi'+pfixb+'SoftDrop', JETCorrPayload='AK8PFPuppi', JETCorrLevels=JETCorrLevels,
                Cut='pt > 170.0 && abs(rapidity()) < 2.4',svLabel=cms.InputTag("WBProducerpuppi1","linkedsvs"), elLabel=cms.InputTag("WBProducerpuppi","newels"), muLabel=cms.InputTag("WBProducerpuppi","newmus"), 
                miniAOD=True, runOnMC=runOnMC,bTagDiscriminators=bTagDiscriminators + _pfDeepBoostedJetTagsProbs + _pfMassDecorrelatedDeepBoostedJetTagsProbs,
    ...
    process.customWBAK8Table = cms.EDProducer("SimpleCandidateFlatTableProducer",
        ...
        variables=cms.PSet(P4Vars,
            ...
            iMDtopfless=Var("userFloat('ImageMDWB:topfless')", float, doc="Image MD top tagger score", precision=-1),
            ...
            iMDWWfless=Var("userFloat('ImageMDWB:wwfless')", float, doc="Image MD ww->qqqq tagger score", precision=-1),
    ...
    process.customMJAK8Table = cms.EDProducer("SimpleCandidateFlatTableProducer",
        ...
        variables=cms.PSet(P4Vars,
            ...
            iMDtopfless=Var("userFloat('ImageMDMJ:topfless')", float, doc="Image MD top tagger score", precision=-1),
            ...
            iMDWWfless=Var("userFloat('ImageMDMJ:wwfless')", float, doc="Image MD ww->qqqq tagger score", precision=-1),
